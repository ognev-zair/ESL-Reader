 ...
 */
package com.ognev.eslreader.translator.translate;

import com.ognev.eslreader.Lang;
import com.ognev.eslreader.translator.ApiKeys;
import com.ognev.eslreader.translator.YandexTranslatorAPI;
...
public final class Translate extends YandexTranslatorAPI {
  ...
  private static final String SERVICE_URL_LANG = "https://translate.yandex.net/api/v1.5/tr.json/getLangs?";
  ...
  public static Lang getLangs() throws Exception {
    final String params =
        PARAM_API_KEY + URLEncoder.encode(apiKey,ENCODING)
            + PARAM_PAIR
            + PARAM_UI + URLEncoder.encode("en",ENCODING);
    final URL url = new URL(SERVICE_URL_LANG + params);
    return retrieveLangs(url);
  }
