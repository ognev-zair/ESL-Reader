...
public class ReadMeActivity extends AppCompatActivity implements FilePicker.FilePickerSupport, SearchView.OnQueryTextListener {
  private Toolbar toolbar;
  private boolean mButtonsVisible;

  public void OnCopyWordButtonClick(View view) {
//        mTopBarMode = TopBarMode.Annot;
//        mTopBarSwitcher.setDisplayedChild(mTopBarMode.ordinal());
//        mAcceptMode = AcceptMode.TranslateWord;
        mDocView.setMode(MuPDFReaderView.Mode.TranslateWord);

//        mAnnotTypeText.setText(getString(com.artifex.mupdfdemo.R.string.translate));
//        showInfo(getString(R.string.select_text));
    }

  private void showToolbarTranslateView(boolean show) {
    toolbar.getMenu().findItem(R.id.translate).setVisible(show);
  }
...
//    if (SearchTaskResult.get() != null && !newText.equals(SearchTaskResult.get().txt)) {
...
//    search(newText);
  ...
  /* The core rendering instance */
    ...
    enum AcceptMode {Highlight, Underline, StrikeOut, Ink, CopyText, TranslateWord};
  ...
  @Override// todo fix search
  public boolean onCreateOptionsMenu(Menu menu) {
    MenuInflater menuInflater = getMenuInflater();
    menuInflater.inflate(R.menu.esl_menu, menu);
//
    MenuItem searchItem = menu.findItem(R.id.action_search);

    SearchManager searchManager = (SearchManager) ReadMeActivity.this.getSystemService(Context.SEARCH_SERVICE);
    ...
    if (searchView != null) {
      ...
      searchView.setSearchableInfo(searchManager.getSearchableInfo(ReadMeActivity.this.getComponentName()));
    }
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    switch (item.getItemId()) {
      ...
      case R.id.settings:
        ...
        break;
      case R.id.translate:
        showToolbarTranslateView(false);
        final SweetAlertDialog sweetAlertDialog = new SweetAlertDialog(ReadMeActivity.this, SweetAlertDialog.PROGRESS_TYPE);
        sweetAlertDialog.setCancelClickListener(new SweetAlertDialog.OnSweetClickListener() {
          @Override
          public void onClick(SweetAlertDialog sweetAlertDialog) {
            sweetAlertDialog.dismissWithAnimation();
            Translator.cancelTranslating();
          }
        });
        sweetAlertDialog.show();


        String realText = mDocView.getSelectedText();
        if(realText.length() > 512) {
          sweetAlertDialog.setContentText(getString(R.string.text_too_large));
          sweetAlertDialog.changeAlertType(SweetAlertDialog.WARNING_TYPE);
          break;
        }

          Translator.translate(realText, new Callback() {
          @Override
          public void onTranslated(final String text) {
            if(!TextUtils.isEmpty(text)) {
              ...
              sweetAlertDialog.setContentText(getString(R.string.smth_happend));
            }
...
//                        Intent intent = new Intent(ReadMeActivity.this, OutlineActivity.class);
...
//        RelativeLayout layout = new RelativeLayout(this);
      ((FrameLayout)findViewById(R.id.mupdfContainer)).addView(mDocView);
...
//            }
//
            Animation anim = new TranslateAnimation(0, 0, -100, 0);
...
//            mTopBarSwitcher.startAnimation(anim);
//
      TranslateAnimation anim = new TranslateAnimation(0, 0, 0, mPageSlider.getHeight());
            anim.setDuration(200);
            anim.setAnimationListener(new Animation.AnimationListener() {
                public void onAnimationStart(Animation animation) {
...
//        mButtonsView = getLayoutInflater().inflate(com.ognev.eslreader.R.layout.readmebuttons, null);
//        mFilenameView = (TextView) mButtonsView.findViewById(com.artifex.mupdfdemo.R.id.docNameText);
        mPageSlider = (SeekBar) findViewById(com.artifex.mupdfdemo.R.id.pageSlider);
        mPageNumberView = (TextView) findViewById(com.artifex.mupdfdemo.R.id.pageNumber);
...
//                MicrosoftTranslateTextDialogFragment fragment = new MicrosoftTranslateTextDialogFragment(this,pageView.getSelectedText());
//                fragment.show(ReadMeActivity.this.getSupportFragmentManager(),"translatedDialog");
                mTopBarMode = TopBarMode.More;
...
//        mSearchTask.go(mSearchText.getText().toString(), direction, displayPage, searchPage);
  ...
  private void search(String text) {
        ...
        SearchTaskResult r = SearchTaskResult.get();
        int searchPage = r != null ? r.pageNumber : -1;
        mSearchTask.go(text, 1, displayPage, searchPage);
    }
    ...
    public void performPickFor(FilePicker picker) {
        mFilePicker = picker;
        Intent intent = new Intent(this, com.artifex.mupdfdemo.ChoosePDFActivity.class);
