...
public class MuPDFReaderView extends ReaderView {
  ...
  public String getSelectedText() {
    ...
    return pageView.getSelectedText();
  }

  public enum Mode {Viewing, Selecting, TranslateWord, Drawing}
  ...
  public boolean onSingleTapUp(MotionEvent e) {
    ...
    if(mMode != Mode.Drawing && event.getAction() == MotionEvent.ACTION_UP && mMode == Mode.TranslateWord)
      touch_up(event);
...
//					touch_up(event);
  ...
  private void touch_up(MotionEvent event) {
    MuPDFView pageView = (MuPDFView)getDisplayedView();
    if (pageView != null)
      pageView.selectWord(event.getX(), event.getY());
    pageView.translateSelection();
